...
export default function Home() {
  ...
  const handleWalletConnection = async (address: string) => {
    try {
      ...
      if (authResponse.success) {
        ...
        const joinResponse = await apiClient.joinGame(address, signature, message)
  ...
  // Show landing page if wallet is not connected or game is not ready
  if (!walletConnected || !showGame) {
    return (
      <LandingPage
  ...
  // Show the game once wallet is connected
  return (
