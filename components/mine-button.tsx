  ...
  return (
    <div className="pointer-events-auto absolute bottom-8 left-1/2 z-30 -translate-x-1/2 transform">
      <button
        onClick={onClick}
        disabled={disabled}
        className={`relative flex items-center gap-2 rounded-full border-2 border-cyan-400 bg-gradient-to-br from-cyan-500 via-teal-400 to-blue-500 px-6 py-2 font-semibold text-white text-base shadow-lg hover:scale-105 active:scale-95 transition-all duration-150 disabled:opacity-60 ${isMining ? "animate-pulse" : ""}`}
        style={{
