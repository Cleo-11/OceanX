...
import { Waves, Anchor, Fish, Zap, Users, Trophy, ArrowRight } from "lucide-react"
...
export function LandingPage({ onWalletConnect, isConnecting, connectionError }: LandingPageProps) {
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <div className="mb-8">
          <button
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-white text-lg shadow-lg shadow-cyan-900/30 transition-all duration-300 hover:shadow-cyan-900/50 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-sm text-slate-500 mt-3">Web3 wallet required • Sepolia Testnet • Free to play</p>
        </div>

        {/* Connection Error */}
        {connectionError && (
          <div className="max-w-md rounded-lg bg-red-900/50 backdrop-blur-sm border border-red-500/30 p-4 text-sm text-red-200">
            <div className="font-semibold text-red-100 mb-1">Connection Error</div>
