        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/90 via-slate-700/90 to-slate-800/90 backdrop-blur-xl border-2 border-cyan-400/30 shadow-2xl shadow-cyan-900/40 w-full max-w-md overflow-hidden rounded-3xl">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/90 via-slate-700/90 to-slate-800/90 backdrop-blur-xl border-2 border-emerald-400/20 shadow-2xl shadow-emerald-900/30 w-full max-w-md overflow-hidden rounded-3xl">
